...
int main(int argc, char **argv) {
  ...
  table* (*new_table)(int) = dlsym(handle, "create_table");
  void (*compare_seq)(table*, char**) = dlsym(handle, "compare_file_sequence");
  void (*rm_block)(table*, int) = dlsym(handle, "remove_block");
  void (*rm_operation)(table*, int, int) = dlsym(handle, "remove_operation");
  #endif
